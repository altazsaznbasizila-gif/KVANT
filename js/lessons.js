document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = {
        ...
        section11: [
            "<b>!ВАЖНО!</b> - запомни, че земното ускорение преобладава само при <i>свободното падане</i>. И двете величини са хоризонтални движения и затова участват в едни и същи задачи.",
            "Примерно четеш задача, в която имаш <i>едно тяло</i>, което го пускат от определена височина - тогава топката получава ускорение, но получава <b>ЕДИНСТВЕНО</b> земно ускорение <b>g</b>.",
            "<b>Как да разбереш дали движението е хоризонтално, или вертикално?</b> - <i>представяш си една ординатна система, в която имаш абсцисна и ордината ос - абсцисата (x) е хоризонталната, а ординатата (y) е вертикалната. Ако лъчът е хоризонтален, това означава, че включваш величини като a, Vo, V, S , но ако е на вертикалната включваш H, h, V, g</i>"
        ],
        section12: [
            ""
        ],
        section14: [
            "<b>Спирачният път</b> има същото свойство като на спирачното време. Той показва пътят, изминат от тялото до пълното му спиране, V = 0 m/s"
        ],
