document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = {
        section2: [
            ...
            " Също така според него скейтборда не се движи - през неговата гледна точка скейтборда е в покой/не извършва движение (действително детето и движещата се дъска извършват едно и също движение и имат еднаква скорост - затова илюзията, че според детето скейтборда не се движи, е теоретически вярно само ако то е отправното тяло )"
        ],
        section3: [
            ...
            "Когато искаме да кажем каква е мерната единица на величината, ограждаме я в квадратни скоби.  <p> Когато едно буквено означение се каже, че е 'константа' това означава, че то има постоянна една и съща стойност, която не се променя.  <p> Обаче при този случай скоростта е НЕравномерна, което означава, че скоростта има променлива стойност. (В един момент може да е 5м/сек, а в друг да е 20м/с).",
            "Този символ 'Δ' се нарича делта и във Физиката се използва в моменти, когато искаме да намерим само частта, в която е използвана някоя величина. Пример: когато намираме Δt, ние искаме да намерим само тази част от времето, което ни е нужно. Делта време се намира като от цялото време извадиш времето, което не включваш. ",
        ...
        section4: [
            "При решаване на тези видове задачи първо пишем дадените величини: S = 250 км. Това е целият път, а ние търсим точно цялата средна скорост, тоест ще ни е от полза.",
            "!!НО ПЪТЯТ НЕ Е ИЗПОЛЗВАН В ОСНОВНАТА СИ МЕРНА ЕДИНИЦА (SI)!! => S = 250 км = 250*10³ м. Понеже 1 км = 1000 м = 10³ м. Превръщаме по-голяма единица в по-малка => умножаваме!",
    ...
    showBtn.addEventListener('click', () => {
        npcAssistant.style.display = 'flex';
